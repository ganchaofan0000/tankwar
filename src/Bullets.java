...
public class Bullets {
	...
	static {
		bulletImages = new Image[] {
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletL.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletR.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletD.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletU.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletLU.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletLD.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletRU.png")),
			tk.getImage(Tank.class.getClassLoader().getResource("Images/BulletRD.png"))
		};
	...
	// 构造函数2，接受另外两个参数
	public Bullets(int x, int y, boolean good, Direction dir, START tc) {
		this(x, y, dir);
		this.good = good;
		this.tc = tc;
	}
